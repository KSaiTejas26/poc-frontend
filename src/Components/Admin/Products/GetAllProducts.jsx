...
const GetAllProducts = () => {
  ...
  const deleteFunction = async () => {
    try {
      const response = await axios.delete(`http://localhost:3000/api/admin/vendors/${data.vendorId}/products/${data.productId}`);
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get('http://localhost:3000/api/admin/allproducts'); // Replace with your API endpoint
                    ...
                    <div key={product._id} className="relative">
                      <div className="group">
                        ...
                        <div className="mt-4 flex flex-column justify-between">
                          ...
                          {/* {console.log(product.pname," ",product.rating)} */}
                          <Box
                            sx={{
                              '& > legend': { mt: 2 },
                            }}
