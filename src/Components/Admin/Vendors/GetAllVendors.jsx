...
//         {/* Table Section */}
//       <h1 className='flex justify-center text-4xl mt-2' style={{fontWeight:'bold'}}>Vendors</h1>
...
//                                 <span className="font-mono text-sm text-blue-600 dark:text-blue-500">#BUSINESS{index + 1}</span>
//                               </span>
//                             </button>
//                           </td>
//                           <td className="size-px whitespace-nowrap">
//                             <button type="button" className="block" data-hs-overlay="#hs-ai-invoice-modal">
//                               <span className="block px-6 py-2">
//                                 <span className="text-sm text-gray-600 dark:text-neutral-400">GST{index + 1}</span>
//                               </span>
//                             </button>
//                           </td>
//                           <td className="size-px whitespace-nowrap">
...
//                             <button type="button" className="block" data-hs-overlay="#hs-ai-invoice-modal">
//                               <span className="block px-6 py-2">
//                                 <span className="text-sm text-gray-600 dark:text-neutral-400">email{index + 1}@example.com</span>
//                               </span>
//                             </button>
//                           </td>
//                           <td className="size-px whitespace-nowrap">
//                             <button type="button" className="block" data-hs-overlay="#hs-ai-invoice-modal">
//                               <span className="block px-6 py-2">
//                                 <span className="text-sm text-gray-600 dark:text-neutral-400">123-456-789{index}</span>
//                               </span>
//                             </button>
//                           </td>
//                           <td className="size-px whitespace-nowrap">
//                             <button type="button" className="block" data-hs-overlay="#hs-ai-invoice-modal" onClick={handleOpen}>
...
//                         <span className="font-semibold text-gray-800 dark:text-neutral-200">10</span> results
//                       </p>
//                     </div>
//                     <div>
...
const GetAllVendors = () => {
  ...
  async function fetchData() {
    axios.get('http://localhost:3000/api/admin/vendors')
     .then(response => {
  ...
  const handledelete = async (id) => {
    try {
      await axios.delete(`http://localhost:3000/api/admin/vendor/delete/${id}`);
