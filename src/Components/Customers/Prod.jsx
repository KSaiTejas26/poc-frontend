...
function Prod(props) {
  ...
  <a className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
    <img className="object-cover w-100" src={props.img} alt="product image" />
  ...
  <div className="mt-4 px-5 pb-5">
    ...
    <a href="#" style={{backgroundColor:'#EF3B36'}}className="flex items-center justify-center rounded-md  px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
